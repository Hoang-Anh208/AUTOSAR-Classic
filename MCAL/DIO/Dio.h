...
#include "..\\MCAL\\Std_Types.h"   /**< Thư viện chứa các kiểu dữ liệu chuẩn của AUTOSAR */
// #include "stm32f10x_gpio.h"     /**< Thư viện chuẩn của STM32F103 */


/**
 * Định nghĩa các giá trị PortId cho các GPIO Port
 */
#define DIO_PORT_A  0   /* Ánh xạ cho GPIO Port A */
#define DIO_PORT_B  1   /* Ánh xạ cho GPIO Port B */
#define DIO_PORT_C  2   /* Ánh xạ cho GPIO Port C */
#define DIO_PORT_D  3   /* Ánh xạ cho GPIO Port D */
...
/**
 * @brief Macro xác định ChannelId cho từng chân GPIO
 * @param[in] GPIOx : cổng GPIO (GPIOA, GPIOB, GPIOC, GPIOD)
 * @param[in] Pin   : số chân từ 0 đến 15
 */
