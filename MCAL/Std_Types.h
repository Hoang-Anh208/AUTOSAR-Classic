 ...
 **********************************************************/
#ifndef NULL_PTR
#define NULL_PTR    ((void*)0x00)   /**< Định nghĩa con trỏ NULL */
#endif  // NULL_PTR
 ...
 * @details Định nghĩa rõ ràng về kích thước và dấu của các 
 *          kiểu dữ liệu.
 **********************************************************/
...
typedef signed long         sint64;     /**< Số nguyên có dấu 64-bit */
 ...
 * @details Cấu trúc này lưu trữ thông tin về phiên bản 
 *          phần mềm của một module.
 **********************************************************/
typedef struct
{
