 ...
 * @details File này chứa các API của DIO Driver theo chuẩn 
 *          AUTOSAR dành cho STM32F103. Driver này cung cấp 
 *          khả năng đọc và ghi các mức logic của các chân 
 *          (GPIO pin) và các cổng (GPIO port) trong 
 ...
 * 
 * @return Dio_LevelType: Trạng thái logic của kênh được chỉ định:
...
Dio_LevelType Dio_ReadChannel(Dio_ChannelType ChannelId)
{
    ...
    uint16 GPIO_Pin;            /**< Số chân GPIO tương ứng */

    /**< Xác định cổng GPIO bằng macro DIO_GET_PORT */
    ...
    /**< Xác định chân GPIO bằng macro DIO_GET_PIN */
    GPIO_Pin = DIO_GET_PIN(ChannelId);

    /**< Đọc trạng thái logic của chân GPIO tương ứng */
...
void Dio_WriteChannel(Dio_ChannelType ChannelId, Dio_LevelType Level)
{
    ...
    /**< Ghi trạng thái logic của chân GPIO tương ứng */
    if (Level == STD_HIGH){
...
Dio_PortLevelType Dio_ReadPort(Dio_PortType PortId)
{
    ...
    /**< Đọc và trả về trạng thái của toàn bộ cổng GPIO */
